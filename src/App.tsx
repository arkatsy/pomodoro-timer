...
import { FastForward, PauseIcon, PlayIcon, RotateCcwIcon } from "lucide-react";
      ...
      <div className="flex min-h-dvh items-center justify-center gap-72">
        <Card className="p-10">
          <CardHeader className="px-0 pb-10">
            <CardTitle className="text-center text-3xl">Pomodoro</CardTitle>
          </CardHeader>
            ...
            >
              ...
              <div className="flex w-full flex-col gap-16">
                <Progress
                  value={progress}
                  max={100}
                  className={`h-2 rounded-md text-primary ${
                ...
                <div className="flex w-full justify-center gap-8">
                  ...
                  <ButtonWithTooltip
                    variant="outline"
                    className="py-6"
                    tooltip={isBreak ? "Skip break" : "Skip pomodoro"}
